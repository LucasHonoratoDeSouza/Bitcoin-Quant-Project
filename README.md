...
| **Current Equity** | `$1,947.11` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.94%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-52.89` | **-2.64%** |
