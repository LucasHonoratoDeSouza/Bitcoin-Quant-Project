...
| **Current Equity** | `$1,942.32` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.94%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-57.68` | **-2.88%** |
