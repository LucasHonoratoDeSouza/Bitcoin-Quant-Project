...
| **Current Equity** | `$1,939.65` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.46%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-60.35` | **-3.02%** |
| **Avg. Monthly Return** | `-0.54%` | Projected (30-day) |
