...
| **Current Equity** | `$1,950.33` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.05%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-49.67` | **-2.48%** |
