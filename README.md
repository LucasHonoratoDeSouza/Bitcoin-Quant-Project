...
| **Current Equity** | `$1,835.16` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.00%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-164.84` | **-8.24%** |
| **Avg. Monthly Return** | `-1.03%` | Projected (30-day) |
