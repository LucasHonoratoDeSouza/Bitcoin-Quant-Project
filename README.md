...
| **Current Equity** | `$1,937.22` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.45%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-62.78` | **-3.14%** |
| **Avg. Monthly Return** | `-0.60%` | Projected (30-day) |
