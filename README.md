...
| **Current Equity** | `$1,940.01` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.98%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-59.99` | **-3.00%** |
