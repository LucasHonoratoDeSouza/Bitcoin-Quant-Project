...
| **Current Equity** | `$1,820.03` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.29%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-179.97` | **-9.00%** |
