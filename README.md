...
| **Current Equity** | `$1,936.60` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.70%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-63.40` | **-3.17%** |
| **Avg. Monthly Return** | `-0.55%` | Projected (30-day) |
