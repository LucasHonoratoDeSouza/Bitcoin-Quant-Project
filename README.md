...
| **Current Equity** | `$1,939.47` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.02%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-60.53` | **-3.03%** |
