...
| **Current Equity** | `$1,828.58` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.90%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-171.42` | **-8.57%** |
