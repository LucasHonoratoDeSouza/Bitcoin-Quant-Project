...
| **Current Equity** | `$1,813.45` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.85%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-186.55` | **-9.33%** |
