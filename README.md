...
| **Current Equity** | `$1,942.29` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.95%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-57.71` | **-2.89%** |
