...
| **Current Equity** | `$1,829.72` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.51%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-170.28` | **-8.51%** |
