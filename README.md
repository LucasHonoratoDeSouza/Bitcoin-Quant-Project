...
| **Current Equity** | `$1,965.03` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `-1.55%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-34.97` | **-1.75%** |
