...
| **Current Equity** | `$1,919.38` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.82%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-80.62` | **-4.03%** |
| **Avg. Monthly Return** | `-0.87%` | Projected (30-day) |
