...
| **Current Equity** | `$1,858.60` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+14.26%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-141.40` | **-7.07%** |
