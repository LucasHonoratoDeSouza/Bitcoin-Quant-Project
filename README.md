...
| **Current Equity** | `$1,816.13` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+20.63%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-183.87` | **-9.19%** |
