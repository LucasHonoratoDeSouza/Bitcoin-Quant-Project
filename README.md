...
| **Current Equity** | `$1,833.26` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.16%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-166.74` | **-8.34%** |
| **Avg. Monthly Return** | `-1.09%` | Projected (30-day) |
