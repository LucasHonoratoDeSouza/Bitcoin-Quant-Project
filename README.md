...
| **Current Equity** | `$1,870.24` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+16.36%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-129.76` | **-6.49%** |
| **Avg. Monthly Return** | `-0.98%` | Projected (30-day) |
