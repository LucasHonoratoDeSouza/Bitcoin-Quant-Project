...
| **Current Equity** | `$1,829.45` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.60%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-170.55` | **-8.53%** |
