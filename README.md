...
| **Current Equity** | `$1,831.01` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.36%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-168.99` | **-8.45%** |
