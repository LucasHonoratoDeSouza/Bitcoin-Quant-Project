...
| **Current Equity** | `$1,946.50` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.14%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-53.50` | **-2.67%** |
