...
| **Current Equity** | `$1,933.65` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.90%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-66.35` | **-3.32%** |
