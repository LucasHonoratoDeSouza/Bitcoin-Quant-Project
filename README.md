...
| **Current Equity** | `$1,960.00` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+0.55%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-40.00` | **-2.00%** |
