...
| **Current Equity** | `$1,823.77` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.97%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-176.23` | **-8.81%** |
