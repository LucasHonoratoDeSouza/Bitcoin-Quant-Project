...
| **Current Equity** | `$1,919.23` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+10.99%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-80.77` | **-4.04%** |
