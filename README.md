...
| **Current Equity** | `$1,941.80` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+4.59%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-58.20` | **-2.91%** |
