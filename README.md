...
| **Current Equity** | `$1,958.89` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+1.02%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-41.11` | **-2.06%** |
