...
| **Current Equity** | `$1,834.63` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.05%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-165.37` | **-8.27%** |
