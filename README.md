...
| **Current Equity** | `$1,835.47` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+16.98%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-164.53` | **-8.23%** |
