...
| **Current Equity** | `$1,825.05` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.86%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-174.95` | **-8.75%** |
