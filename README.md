...
| **Current Equity** | `$1,848.08` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+15.91%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-151.92` | **-7.60%** |
