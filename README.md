...
| **Current Equity** | `$1,937.92` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.16%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-62.08` | **-3.10%** |
