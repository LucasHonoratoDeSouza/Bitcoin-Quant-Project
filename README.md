...
| **Current Equity** | `$1,937.69` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+9.88%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-62.31` | **-3.12%** |
| **Avg. Monthly Return** | `-0.32%` | Projected (30-day) |
