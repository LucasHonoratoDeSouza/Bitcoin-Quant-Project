...
| **Current Equity** | `$1,930.13` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+9.33%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-69.87` | **-3.49%** |
