...
| **Current Equity** | `$1,948.51` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.35%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-51.49` | **-2.57%** |
