...
| **Current Equity** | `$1,823.62` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+19.60%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-176.38` | **-8.82%** |
