...
| **Current Equity** | `$1,935.64` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.09%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-64.36` | **-3.22%** |
