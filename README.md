...
| **Current Equity** | `$1,843.38` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.16%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-156.62` | **-7.83%** |
| **Avg. Monthly Return** | `-1.16%` | Projected (30-day) |
