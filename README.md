...
| **Current Equity** | `$1,873.51` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+12.93%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-126.49` | **-6.32%** |
| **Avg. Monthly Return** | `-1.45%` | Projected (30-day) |
