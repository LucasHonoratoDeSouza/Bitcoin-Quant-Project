...
| **Current Equity** | `$1,832.41` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.24%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-167.59` | **-8.38%** |
| **Avg. Monthly Return** | `-1.11%` | Projected (30-day) |
