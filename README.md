...
| **Current Equity** | `$1,946.03` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.39%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-53.97` | **-2.70%** |
