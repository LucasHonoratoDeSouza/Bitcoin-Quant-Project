...
| **Current Equity** | `$1,846.22` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.93%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-153.78` | **-7.69%** |
| **Avg. Monthly Return** | `-1.13%` | Projected (30-day) |
