...
| **Current Equity** | `$1,808.17` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+21.06%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-191.83` | **-9.59%** |
| **Avg. Monthly Return** | `-1.40%` | Projected (30-day) |
