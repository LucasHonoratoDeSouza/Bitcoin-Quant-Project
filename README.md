...
| **Current Equity** | `$1,943.70` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.29%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-56.30` | **-2.81%** |
