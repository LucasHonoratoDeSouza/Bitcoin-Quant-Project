...
| **Current Equity** | `$1,959.19` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+0.89%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-40.81` | **-2.04%** |
