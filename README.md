...
| **Current Equity** | `$1,949.43` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+4.97%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-50.57` | **-2.53%** |
| **Avg. Monthly Return** | `-0.27%` | Projected (30-day) |
