...
| **Current Equity** | `$1,826.12` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.74%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-173.88` | **-8.69%** |
| **Avg. Monthly Return** | `-1.22%` | Projected (30-day) |
