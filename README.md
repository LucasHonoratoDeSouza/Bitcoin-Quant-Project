...
| **Current Equity** | `$1,827.86` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.62%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-172.14` | **-8.61%** |
