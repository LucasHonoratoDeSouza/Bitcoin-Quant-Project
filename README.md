...
| **Current Equity** | `$1,828.68` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.55%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-171.32` | **-8.57%** |
| **Avg. Monthly Return** | `-1.00%` | Projected (30-day) |
