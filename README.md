...
| **Current Equity** | `$1,942.21` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+4.42%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-57.79` | **-2.89%** |
