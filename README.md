...
| **Current Equity** | `$1,948.04` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.55%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-51.96` | **-2.60%** |
| **Avg. Monthly Return** | `-0.28%` | Projected (30-day) |
