...
| **Current Equity** | `$1,952.77` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+3.58%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-47.23` | **-2.36%** |
