...
| **Current Equity** | `$1,941.85` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.14%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-58.15` | **-2.91%** |
