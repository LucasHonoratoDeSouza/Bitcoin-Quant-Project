...
| **Current Equity** | `$1,839.06` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+16.67%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-160.94` | **-8.05%** |
