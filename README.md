...
| **Current Equity** | `$1,824.16` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.94%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-175.84` | **-8.79%** |
