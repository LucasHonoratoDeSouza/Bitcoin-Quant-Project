...
| **Current Equity** | `$1,820.44` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.25%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-179.56` | **-8.98%** |
