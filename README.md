...
| **Current Equity** | `$1,827.41` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+19.74%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-172.59` | **-8.63%** |
