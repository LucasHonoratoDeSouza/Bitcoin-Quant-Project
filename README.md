...
| **Current Equity** | `$1,936.07` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.30%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-63.93` | **-3.20%** |
