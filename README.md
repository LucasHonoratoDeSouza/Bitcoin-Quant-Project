...
| **Current Equity** | `$1,820.78` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.22%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-179.22` | **-8.96%** |
