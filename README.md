...
| **Current Equity** | `$1,943.31` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.68%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-56.69` | **-2.83%** |
