...
| **Current Equity** | `$1,946.53` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+2.67%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-53.47` | **-2.67%** |
| **Avg. Monthly Return** | `-0.47%` | Projected (30-day) |
