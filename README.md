...
| **Current Equity** | `$1,939.22` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+9.24%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-60.78` | **-3.04%** |
