...
| **Current Equity** | `$1,827.79` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.63%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-172.21` | **-8.61%** |
