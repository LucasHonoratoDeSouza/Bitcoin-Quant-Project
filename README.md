...
| **Current Equity** | `$1,941.96` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.09%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-58.04` | **-2.90%** |
