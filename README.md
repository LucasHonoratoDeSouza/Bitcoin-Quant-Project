...
| **Current Equity** | `$1,841.18` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.65%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-158.82` | **-7.94%** |
