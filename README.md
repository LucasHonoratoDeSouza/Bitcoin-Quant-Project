...
| **Current Equity** | `$1,811.75` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+20.77%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-188.25` | **-9.41%** |
