...
| **Current Equity** | `$1,960.19` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+0.47%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-39.81` | **-1.99%** |
