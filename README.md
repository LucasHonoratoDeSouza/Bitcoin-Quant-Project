...
| **Current Equity** | `$1,935.17` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.28%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-64.83` | **-3.24%** |
