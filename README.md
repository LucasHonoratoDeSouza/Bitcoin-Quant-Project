...
| **Current Equity** | `$1,825.60` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.92%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-174.40` | **-8.72%** |
