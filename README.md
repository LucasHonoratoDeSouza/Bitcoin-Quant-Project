...
| **Current Equity** | `$1,837.73` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+16.78%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-162.27` | **-8.11%** |
