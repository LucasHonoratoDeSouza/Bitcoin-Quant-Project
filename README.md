...
| **Current Equity** | `$1,936.22` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.85%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-63.78` | **-3.19%** |
