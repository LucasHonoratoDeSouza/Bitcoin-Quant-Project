...
| **Current Equity** | `$1,933.66` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+7.89%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-66.34` | **-3.32%** |
