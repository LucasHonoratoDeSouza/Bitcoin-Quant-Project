...
| **Current Equity** | `$1,965.21` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `-1.62%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-34.79` | **-1.74%** |
| **Avg. Monthly Return** | `-0.17%` | Projected (30-day) |
