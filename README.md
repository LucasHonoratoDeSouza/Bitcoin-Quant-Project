...
| **Current Equity** | `$1,843.31` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.48%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-156.69` | **-7.83%** |
| **Avg. Monthly Return** | `-1.21%` | Projected (30-day) |
