...
| **Current Equity** | `$1,902.77` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+12.62%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-97.23` | **-4.86%** |
| **Avg. Monthly Return** | `-0.78%` | Projected (30-day) |
