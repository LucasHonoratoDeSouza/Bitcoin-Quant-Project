...
| **Current Equity** | `$1,949.54` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.89%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-50.46` | **-2.52%** |
