...
| **Current Equity** | `$1,921.97` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+10.72%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-78.03` | **-3.90%** |
