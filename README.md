...
| **Current Equity** | `$1,944.20` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.08%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-55.80` | **-2.79%** |
