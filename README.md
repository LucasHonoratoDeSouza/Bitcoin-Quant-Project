...
| **Current Equity** | `$1,829.83` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+17.46%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-170.17` | **-8.51%** |
