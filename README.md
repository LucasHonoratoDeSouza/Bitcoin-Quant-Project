...
| **Current Equity** | `$1,938.12` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+6.08%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-61.88` | **-3.09%** |
