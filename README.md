...
| **Current Equity** | `$1,825.91` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+18.81%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-174.09` | **-8.70%** |
