...
| **Current Equity** | `$1,952.20` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+4.80%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-47.80` | **-2.39%** |
