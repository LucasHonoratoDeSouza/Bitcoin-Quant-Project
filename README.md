...
| **Current Equity** | `$1,949.74` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+5.81%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-50.26` | **-2.51%** |
