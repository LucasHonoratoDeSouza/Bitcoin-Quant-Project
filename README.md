...
| **Current Equity** | `$1,940.68` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+8.63%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-59.32` | **-2.97%** |
