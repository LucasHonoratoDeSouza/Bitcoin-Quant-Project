...
| **Current Equity** | `$1,945.14` | Updated from the latest paper trading snapshot |
| **Alpha vs BTC** | `+3.23%` | Strategy ROI minus BTC buy-and-hold ROI over the same forward-testing window |
| **Net Profit** | `$-54.86` | **-2.74%** |
